...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.analytics-text').forEach(el => observer.observe(el));
    document.querySelectorAll('.analytics-chart').forEach(el => observer.observe(el));
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        const parallaxElements = document.querySelectorAll('.service-card, .client-card');
    ...
    function animateOnScroll() {
        const elements = document.querySelectorAll('.service-card, .advanced-item, .client-card');
...
window.addEventListener('load', function() {
    ...
    preloader.innerHTML = `
        <div style="text-align: center; color: white;">
            <div style="font-size: 2rem; margin-bottom: 20px;">YASU</div>
            <div style="font-size: 1rem; color: var(--primary-blue);">DIGITAL</div>
        </div>
    `;
