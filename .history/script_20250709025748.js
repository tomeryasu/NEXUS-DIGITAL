...
function fillMarquee(lineSelector) {
  ...
  const repeatCount = Math.ceil(containerWidth / contentWidth) + 2; // +2 for seamlessness
...
startInfiniteScroll('.scroll-line.scroll-left', 1, -1);
// Right to left (direction = 1)
startInfiniteScroll('.scroll-line.scroll-right', 1, 1);

// Optional: Refill on window resize for responsiveness
